...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::msg::Image> left_sub(node, "/camera/left/image_raw");
    message_filters::Subscriber<sensor_msgs::msg::Image> right_sub(node, "/camera/right/image_raw");

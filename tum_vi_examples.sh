#!/bin/bash
pathDatasetTUM_VI='/mnt/hgfs/vmshare/bj_stereo_fisheye_3' #Example, it is necesary to change it by the dataset path
...
./Examples/Stereo/stereo_tum_vi Vocabulary/ORBvoc.txt "$pathDatasetTUM_VI"/bj_stereo_fisheye.ymal "$pathDatasetTUM_VI"/cam0 "$pathDatasetTUM_VI"/cam1 "$pathDatasetTUM_VI"/bj_stereo_fisheye_time3.txt bj_stereo_fisheye_1
